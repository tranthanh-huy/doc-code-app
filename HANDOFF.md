...
- **Drift đã xử lý (2026-07-17):** người dùng chọn BỎ nhắc flashcard trong skill (cho khớp app
  hiện chỉ-đọc). Đã gỡ hết mọi chỗ skill nói "app chấm tiến độ / ôn flashcard"; giờ skill dạy
  tại-chỗ (đoán trước, sửa ngay), chứng tỏ hiểu bằng cách KỂ LẠI bằng lời mình, không chấm điểm.
  `sodo.json` vẫn chỉ chứa cấu trúc; id giữ ổn định để bản đồ vẽ lại vẫn khớp ghi-chu.md.
- Nếu sau này muốn làm lại "ôn tập" trong app, hỏi người dùng muốn kiểu gì trước (đã gỡ flashcard).
